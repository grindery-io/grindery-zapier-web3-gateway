...
const perform = async (z, bundle) => {
  ...
  try {
    ...
    let response = await client.connector.get({ driverKey: "safeTriggers" });
...
module.exports = {
  ...
  key: `safeTriggers_hidden`,
  noun: `SafeTriggers Token`,

  display: {
    label: `SafeTriggers Token`,
    description: `Triggers when a new safeTriggers is created.`,
    hidden: true,
  },
