...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      ...
      z.console.log("Error in creatorID function (erc20.js)", error.message);
    }
  }
};
...
module.exports = {
  ...
  display: {
    ...
    description:
      "Triggers when an ERC-20 token transaction occurs on Ethereum, Binance, or any other EVM Chain (connector created by Grindery).",
  },
