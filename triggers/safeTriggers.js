...
const driver_id = "safeTriggers";
const safeTriggers_hidden = require("./safeTriggers_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (safeTriggers.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (safeTriggers.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  key: "safeTriggers",
  noun: "SafeTriggers Token",

  display: {
    label: "Safe (2.0.0)",
    description: "Triggers when new Safe wallet event occurs (connector created by Grindery).",
  },
  ...
  operation: {
    ...
    inputFields: [
      ...
      },
      {
        ...
        dynamic: "safeTriggers_hidden.key",
      },
